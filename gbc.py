...
st.title("Prediction Mobile Churn Analysis For Mitigration Strategies In Telecommunication Industry")
#Train model
...
#Create prediction button
    ...
    if prediction_proba > 0.5:
        ...
        prediction = "False"
    st.write(f"Predicting Mobile Churn Analysis in Telecommunication Industry is:", prediction_proba)
